...
scope, which makes that artifact harder to unit-test than the final project — it assumes the real
...
- Vendor and community references — Raspberry Pi GPIO docs, Adafruit CircuitPython guides, and the
  AHT20 datasheet — which I'll keep relying on for future hardware projects.
